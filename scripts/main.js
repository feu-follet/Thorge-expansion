...
//since my git is shitty and wont upload all files
//here's a work around, because big brain time
//i just paste this all here so even if the other js files
//didnt upload it still works
